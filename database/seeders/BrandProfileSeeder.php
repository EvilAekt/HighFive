...
class BrandProfileSeeder extends Seeder
{
    public function run(): void
    {
        BrandProfile::create([
            ...
            'story' => 'Didirikan pada tahun 2026, HIGH FIVE lahir dari visi sederhana: menciptakan pakaian berkualitas tinggi dengan desain minimalis yang dapat diakses oleh semua orang. Kami percaya bahwa gaya yang baik tidak harus rumit atau mahal.',
